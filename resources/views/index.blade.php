<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('{{Storage::url("common/patron3.jpg")}}')">
    </div>
    <div class="flex   justify-center mt-12 text-center">
                <a href="{{route('reservations.create')}}" type="button"
                   class="karam-elsham-bgcolor2 btn-hv max-w-md inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white bg-green-600 rounded-full lg:w-full md:w-auto hover:bg-green-500 focus:outline-none">
                    Make your Reservation
                </a>
    </div>
    <!-- End Main Hero Content -->
    <section class="px-2 py-8 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        ...
                        <div class="relative flex">
                            <a href="#_"
                                class="karam-elsham-bgcolor karam-elsham-color btn-hv flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-green-600 rounded-md sm:mb-0 hover:bg-green-700 sm:w-auto">
                                Read More
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="{{Storage::url('common/karam11.jpg')}}" />
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="w-full lg:max-w-md">
                        ...
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Faster Food  Delivery</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                            ...
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">100% Delicious Food </span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        <div class="mt-6 mb-4 text-center">
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                Special Offers </h2>
            <p class="text-xl text-white">Offers Made Specially To Let You Taset The Magic Foods</p>
        </div>
            ...
            <div class="grid lg:grid-cols-4 gap-y-6">
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                    <h4
                        ...
                        Offer 1 Only 130 pounds</h4>
                        <img class="w-full h-48" src="{{ Storage::url('common/offers/offer5.jpg') }}" alt="Image" />
                </div>
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                    <h4
                        class="mb-3 text-xl font-semibold tracking-tight text-green-600 hover:text-green-400 uppercase">
                        Offer 2 Only 150 pounds</h4>
                    <img class="w-full h-48" src="{{ Storage::url('common/offers/offer4.jpg') }}" alt="Image" />
                </div>
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                    <h4
                        class="mb-3 text-xl font-semibold tracking-tight text-green-600 hover:text-green-400 uppercase">
                        Offer 3 Only 160 pounds</h4>
                    <img class="w-full h-48" src="{{ Storage::url('common/offers/offer3.jpg') }}" alt="Image" />
                </div>
                <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                    <h4
                        class="mb-3 text-xl font-semibold tracking-tight text-green-600 hover:text-green-400 uppercase">
                        Offer 3 Only 100 pounds</h4>
                    <img class="w-full h-48" src="{{ Storage::url('common/offers/offer2.jpg') }}" alt="Image" />
                </div>
            </div>
        </div>
    </section>
